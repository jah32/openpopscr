...
I will simulate a survey that is conducted over three strata. The idea is that strata
may share some parameters (i.e. parameters are equal among strata) and for
other parameters, each stratum has its own particular value. Strata are
...
I create a <code>ScrData</code> object for each stratum separately and then
